...
| `* * *`  | user                                       | add a new internshipApplication               |                                                                        |
| `* * *`  | user                                       | delete a internshipApplication                | remove entries that I no longer need                                   |
| `* * *`  | user                                       | find a internshipApplication by companyName          | locate details of internshipApplications without having to go through the entire list |
| `* *`    | user                                       | hide private contact details   | minimize chance of someone else seeing them by accident                |
| `*`      | user with many internshipApplications in the description book | sort internshipApplications by companyName           | locate a internshipApplication easily                                                 |
...
**Use case: Delete a internshipApplication**

**MSS**

1.  User requests to list internshipApplications
2.  AddressBook shows a list of internshipApplications
3.  User requests to delete a specific internshipApplication in the list
4.  AddressBook deletes the internshipApplication
...
2.  Should be able to hold up to 1000 internshipApplications without a noticeable sluggishness in performance for typical usage.
