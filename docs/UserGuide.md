...
### Adding a internshipApplication: `add`

Adds a internshipApplication to the description book.
...
Shows a list of all internshipApplications in the description book.
