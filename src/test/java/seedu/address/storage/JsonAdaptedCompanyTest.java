...
// Assuming BENSON is now a mock InternshipApplication instance
...
// Updated imports to use the 'Company' package for all model components
...
public class JsonAdaptedCompanyTest {
    ...
    private JsonAdaptedCompany getValidAdaptedApplication() {
        return new JsonAdaptedCompany(
                VALID_COMPANY_NAME, VALID_INDUSTRY, VALID_JOB_TYPE, VALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS
        );
    }
    ...
    public void toModelType_invalidCompanyName_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(INVALID_COMPANY_NAME, VALID_INDUSTRY, VALID_JOB_TYPE,
                        VALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_nullCompanyName_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(null, VALID_INDUSTRY, VALID_JOB_TYPE,
                        VALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_invalidIndustry_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, INVALID_INDUSTRY, VALID_JOB_TYPE,
                        VALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_nullIndustry_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, null, VALID_JOB_TYPE,
                        VALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_invalidJobType_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_INDUSTRY, INVALID_JOB_TYPE,
                        VALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_nullJobType_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_INDUSTRY, null,
                        VALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_INDUSTRY, VALID_JOB_TYPE,
                        INVALID_EMAIL, VALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_INDUSTRY, VALID_JOB_TYPE,
                        VALID_EMAIL, INVALID_DESCRIPTION, VALID_STATUS);
    ...
    public void toModelType_invalidStatus_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_INDUSTRY, VALID_JOB_TYPE,
                        VALID_EMAIL, VALID_DESCRIPTION, INVALID_STATUS);
    ...
    public void toModelType_nullStatus_throwsIllegalValueException() {
        JsonAdaptedCompany application =
                new JsonAdaptedCompany(VALID_COMPANY_NAME, VALID_INDUSTRY, VALID_JOB_TYPE,
                        VALID_EMAIL, VALID_DESCRIPTION, null);
